...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Dec 2021 13:57:09 GMT -->
...
<body>
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle" src="{{asset('dashboard/images/avatars/1.jpg')}}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                ...
                                <!--<li class="theme-settings-swatches d-none list-group-item">
                                    ...
                                    <div class="swatch-holder swatch-holder-img active">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/city1.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/city2.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/city3.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/city4.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/city5.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/abstract1.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/abstract2.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/abstract3.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/abstract4.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{asset('dashboard/images/sidebar/abstract5.jpg')}}">
                                        </a>
                                    </div>
                                </li>-->
                            </ul>
                                ...
                                <ul      >
                                    <li>
                                        <a href="index-2.html"  class="mm-active" >
                                            <i class="metismenu-icon"></i>Services
                                        </a>
                                    </li>
                                    @foreach($services as  $service)
                                    <li>
                                        <a href="{{ route('admin', $service->id)}}" >
                                            <i class="metismenu-icon"></i>{{$service->service}}
                                        </a>
                                    </li>
                         @endforeach
                                </ul>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Active Users
                                        <div class="btn-actions-pane-right">
                                            <div role="group" class="btn-group-sm btn-group">
                                                <button class="active btn btn-focus">{{date('Y-m-d')}}</button>
                                                <button class="btn btn-focus">{{date('H:i:s')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">  {{$customer->ticketNo}}    </td>
                                                    <td class="text-center">{{$customer->name}}</td>
                                                    <td class="text-center" >
                                                       {{$customer->queueNo}}</div>
                                                    </td>
                                                    <td class="text-center">
                                                        @if($customer->status =="active")
                                                        <div class="badge badge-warning">Pending</div>
                                                        @elseif($customer->status =="Finish")
                                                        <div class="badge badge-warning">Pending</div>
                                                        @endif
                                                    </td>
                                                   <td class="text-center">
                                                    <a onclick="event.preventDefault(); document.getElementById('submit-form').submit();" href="{{Route('Admindestroy', $customer->id)}}">
                                                        <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm">delete</button></a>
                                                        <form id="submit-form" action="{{ route('Admindestroy',  $customer->id)}}" method="POST" class="hidden"> @csrf</form>
</td>
 </tr>
                                             @endforeach
                                            </tbody>
                                                                                        ...
                                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/1.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/2.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/3.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/4.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/5.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/9.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/7.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon">
                                                                                                    <img src="{{asset('dashboard/images/avatars/8.jpg')}}" alt="">
                                                                                                </div>
                                                                                            </div>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                                <img width="42" class="rounded" src="{{asset('dashboard/images/avatars/1.jpg')}}" alt="" />
                                            </div>
                                        </div>
                                        <div class="widget-content-left">
                                    ...
                                    <div class="vertical-timeline-element-content bounce-in">
                                        <h4 class="timeline-title">Something not important
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                ...
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="{{asset('dashboard/images/avatars/6.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
    ...
    <div class="app-drawer-overlay d-none animated fadeIn"></div><script type="text/javascript" src="{{asset('dashboard/scripts/main.d810cf0ae7f39f28f336.js')}}"></script></body>


<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Dec 2021 13:58:06 GMT -->
</html>